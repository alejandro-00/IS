    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (data == '') {
          ...
          buttonValidar.className = "ml-2 btn btn-primary";
          buttonValidar.innerHTML = "Registrar visita";
...
function registroExitoso(){
  var mat = document.getElementById("mat");
  var formID = document.getElementById("formMatrIngr");

  credesc.className = "alert alert-success text-center mt-5";
  credesc.innerHTML = "<span class='icon-ok rounded-circle text-center'></span> ¡Has registrado tu visita con éxito!";
  formID.removeChild(mat);

  setTimeout(function(){

    credesc.className = "alert alert-info text-center mt-5";
    credesc.innerHTML = "<span class='icon-credit-card rounded-circle text-center'></span> Pasa tu credencial por el escáner.";
